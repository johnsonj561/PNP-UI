...
/**
 * JPanel that lists a defined part's features horizontally
 * Features listed includes: Footprint, Value, Location of 1st Part (X,Y)
 * @author Justin Johnson
 *
 */
public class DefinedPartFeatures extends JPanel{
	 ...
	 * 
	 */
	public DefinedPartFeatures(int partNumber, String footprint, String value) {
