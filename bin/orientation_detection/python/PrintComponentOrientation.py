...
def main():
  ...
  ap.add_argument("-ht", "--high", help = "high threshold value used for creating binary image", type=int, default=160)
  ap.add_argument("-ma", "--minarea", help = "minimum pixel area of contour; small contours will be ignored", type=int, default=5000)
